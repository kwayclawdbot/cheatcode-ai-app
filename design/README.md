# Design sources
- `artboards/` — CURRENT export of `Cheat Code AI - Core Screens.dc.html` (2026-08-27, V5 tier on top). Pixel truth: DOM + inline styles.
- `artboards-v1/` — previous export (2026-08-26). Reference only.
