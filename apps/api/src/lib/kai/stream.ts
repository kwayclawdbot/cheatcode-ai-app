...
/*
 * The "can Kai actually answer" check that used to live here moved to
 * `./anthropic-health.ts`, where it makes a real one-token call: listing
 * models could not see an empty credit balance.
 */
